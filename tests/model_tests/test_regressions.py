...
def test_reparent_bug_issues_27(site):
    ...
    net_31 = models.Network.objects.create(site=site, cidr="10.17.244.128/31")
    net_25 = models.Network.objects.create(site=site, cidr="10.16.1.0/25")
...
def test_next_network_bug_issues_247(site):
    ...
    for i in range(1, 5):
        models.Network.objects.create(
            site=site, cidr=f"10.20.0.{i}/32", state=models.Network.ASSIGNED
        )
