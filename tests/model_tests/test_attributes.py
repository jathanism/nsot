...
def test_creation(site):
    attr = models.Attribute.objects.create(
        resource_name="Network", site=site, name="test_attribute"
    )
...
def test_conflict(site):
    ...
    models.Attribute.objects.create(
        resource_name="Network", site=site, name="test_attribute_2"
    )
...
def test_required(site):
    attribute_1 = models.Attribute.objects.create(
        resource_name="Network", site=site, name="required_1", required=True
    )
    attribute_2 = models.Attribute.objects.create(
        resource_name="Network", site=site, name="required_2", required=True
    )
...
def test_multi(site):
    ...
    not_multi = models.Attribute.objects.create(
        resource_name="Network", site=site, name="not_multi", multi=False
    )
...
def test_set_query(site):
    ...
    device1 = models.Device.objects.create(
        hostname="foo-bar1",
        attributes={"owner": "jathan", "role": "br"},
        site=site,
    )
    device2 = models.Device.objects.create(
        hostname="foo-bar2",
        attributes={"owner": "gary", "role": "dr"},
        site=site,
    )
