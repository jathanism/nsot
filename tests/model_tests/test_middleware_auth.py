...
def test_object_level_permissions_with_ancestors(site, user, test_group):
    ...
    net_8 = models.Network.objects.create(site=site, cidr="8.0.0.0/8")
    net_24 = models.Network.objects.create(site=site, cidr="8.0.0.0/24")
    net_16 = models.Network.objects.create(site=site, cidr="8.0.0.0/16")
